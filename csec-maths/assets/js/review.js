 ...
 * assets/js/review.js. qa-suite.mjs pins that file's SHA-256; when it changes
 * upstream the suite fails and tells you to re-port this one. See
 * PHASE8_ADAPTER.md — fix upstream first, never edit this copy directly.
 *
 * The renderer is syllabus-agnostic: it takes the attempt, the reviewer identity
 * and the submit strategy as arguments. The in-page adapter at the foot activates
 * on document.body.dataset.reviewKind and reads window.AlphaMathExam, which this
 * build's exam.js already exposes.
 */
(function(){
  "use strict";
